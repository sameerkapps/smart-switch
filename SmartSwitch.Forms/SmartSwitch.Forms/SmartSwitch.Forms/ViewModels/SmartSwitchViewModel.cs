...
namespace SmartSwitch.Forms.ViewModels
{
    ...
    /// </summary>
    public class SmartSwitchViewModel
        : BaseViewModel
    {
        // Link to my project
        ...
        public DeviceInfo SelectedDevice
        {
            ...
            set { _selectedDevice = value; ((Command)Connect).ChangeCanExecute(); } // Connect.RaiseCanExecuteChanged()
        }

        /// <summary>
        /// Index of the selected device. This is required as Picker i Xamarin Forms does not have 
        /// SelectedItem property. Instead it has SelectedIndex property.
        /// </summary>
        ...
        public int SelectedDeviceIndex
        {
            ...
            set 
            {
                // Somehow Items.Clear sets the value to -1
                // so this is a workaround
                _selectedDeviceIndex = value;
                if (value < 0 ||
                    value > (_devices.Count() - 1))
                {
                    SelectedDevice = null;
                }
                else
                {
                    SelectedDevice = Devices[_selectedDeviceIndex];
                }
                
                RaisePropertyChanged("SelectedDeviceIndex");
            }
        }
